    ...
    private View.OnClickListener flashListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            try {
                ...
                if (isFlashOn) {
                    // 关闭闪光灯
                    Toast.makeText(CaptureActivity.this, "Flash light closed", Toast.LENGTH_SHORT).show();
                    btnFlash.setImageResource(R.drawable.flash_off);
                    isFlashOn = false;
                } else {
                    // 开启闪光灯
                    Toast.makeText(CaptureActivity.this, "Flash light opened", Toast.LENGTH_SHORT).show();
